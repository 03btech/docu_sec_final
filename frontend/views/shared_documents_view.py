...
class SharedDocumentsView(QWidget):
    ...
    def setup_ui(self):
        ...
        # Description
        description = QLabel("Documents that other users have shared with you")
    ...
    def load_documents(self):
        try:
            self.documents = self.api_client.get_shared_with_me_documents()
            self.populate_table()
        except Exception as e:
            QMessageBox.critical(self, "Error", f"Failed to load shared documents: {str(e)}")
